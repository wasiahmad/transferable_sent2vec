...
def get_args():
    parser = ArgumentParser(description='adversarial_multitask_learning')
    ...
    parser.add_argument('--adversarial', action='store_true',
                        help='turn on adversarial training')
    ...
    parser.add_argument("--pool_type", type=str, default='max',
                        help="pool type to form vectors from rnn hidden states")
    ...
    parser.add_argument('--beta', type=float, default=0.05,
                        help='hyper-parameter for adversarial loss')
    parser.add_argument('--gamma', type=float, default=0.01,
                        help='hyper-parameter for difference loss')
    ...
    parser.add_argument('--optfile', default='./models/elmo/elmo_2x4096_512_2048cnn_2xhighway_options.json', type=str,
                        help='options file for ELMo')
    parser.add_argument('--wgtfile', default='./models/elmo/elmo_2x4096_512_2048cnn_2xhighway_weights.hdf5', type=str,
                        help='weight file for ELMo')
    parser.add_argument('--resume', default='', type=str, metavar='PATH',
                        help='resume from last checkpoint (default: none)')
    parser.add_argument('--save_path', type=str, default='../adversarial_output/',
