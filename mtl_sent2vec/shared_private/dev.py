...
#
# File Description: This script contains code to test the model on dev dataset.
###############################################################################
...
if __name__ == "__main__":
    ...
    if tasks:
        ...
        if args.cuda:
            model = model.cuda()
        helper.load_model_states_from_checkpoint(model, args.save_path + 'model_best.pth.tar', 'state_dict_G', args.cuda)
